document.addEventListener('DOMContentLoaded', function() {
    ...
    window.onclick = function(event) {
        var modals = [
            "deleteModal", "addRestaurantModal",
        ];
...
function initializeModals() {
    initializeAddRestaurantInfoModalEvents();
}
...
// Các hàm khởi tạo modal khác (giữ nguyên hoặc thay đổi nếu cần)

function initializeAddRestaurantInfoModalEvents() {
